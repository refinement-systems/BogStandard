...
/**
 * Vendored from reference/pi-mono/packages/coding-agent/examples/extensions/questionnaire.ts
 * Purpose: enable plan-mode clarifying questions in BogStandard.
 * MIT-licensed upstream work; see reference/pi-mono/LICENSE for attribution and license terms.
 */
		...
		async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
			...
			const result = await ctx.ui.custom<QuestionnaireResult>((tui, theme, _kb, done) => {
				...
				function render(width: number): string[] {
					...
					// Helper to add wrapped multi-line content (preserves ANSI across breaks)
